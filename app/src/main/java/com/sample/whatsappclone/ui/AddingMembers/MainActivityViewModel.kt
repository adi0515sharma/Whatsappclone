...
class MainActivityViewModel : ViewModel(){
    ...
    lateinit var allRecords : LiveData<List<Contact>>
    ...
    fun setUp(context : Context){
        ...
        allRecords = repository.fetchUpdatedRecords()
    }

    fun fetch_records() : LiveData<List<Contact>>{
        return allRecords
    }


    public fun fetchPhoneContacts(){
